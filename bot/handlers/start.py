...
async def cmd_help(message: Message) -> None:
    await message.answer(
        ...
        "2. Сделайте снимок и при необходимости обведите товар\n"
        "3. Дождитесь GPS и адреса\n"
        "4. Укажите локацию, вес и примечание\n"
        "5. В меню WebApp можно отправить сводку боту или выгрузить CSV"
    )
